...
export function WritePage({ onNavigate }: WritePageProps) {
  ...
  return (
    <div className="min-h-screen bg-background pb-24 lg:pb-0">
      {/* Header */}
      <div className="sticky top-0 z-30 bg-background/95 border-b border-border px-4 pt-4 pb-3" style={{ backdropFilter: 'blur(12px)' }}>
        <div className="max-w-4xl mx-auto">
          <div className="flex items-center justify-between mb-4">
            {/* Mobile title */}
            <div className="lg:hidden">
              <h1 className="text-xl font-bold text-foreground" style={{ fontFamily: 'var(--font-family-display)' }}>✍️ Mes manuscrits</h1>
              <p className="text-xs text-muted-foreground mt-0.5">{stories.length} histoires · {totalChapters} chapitres</p>
            </div>
            {/* Desktop title (gradient) */}
            <div className="hidden lg:block">
              <h1 className="text-2xl font-bold" style={{ fontFamily: 'var(--font-family-display)', background: 'linear-gradient(135deg, #7C5CFF, #A67CFF)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>
                ✍️ Mes manuscrits
              </h1>
